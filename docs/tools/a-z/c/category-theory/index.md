...
description: "Category theory as a tool — what it does when held as an instrument for relational analysis."
---

[Home](/) > [Tools](/tools/) > [A–Z](/tools/a-z/) > Category theory
...
**[Lambek](https://en.wikipedia.org/wiki/Joachim_Lambek)** — categorical grammar. Syntax as a pregroup, where grammatical types compose by adjunction. The first systematic use of CT as a tool for language structure.

**[DisCoCat](https://en.wikipedia.org/wiki/DisCoCat)** — distributional compositional categorical models. Coecke, Sadrzadeh, Clark. Combines distributional semantics (meaning from context) with categorical composition (meaning from structure). The sentence is a morphism; meaning composes categorically.
