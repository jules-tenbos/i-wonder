...
layout: default
lastmod: 2026-06-13
title: "The three core values"
description: "Belonging, privacy, creativity as a philosophical triad — who works with subsets, who holds structural analogues, and where each account reaches and stops."
---

[Home](/) > [Positioning](/positioning/) > [Close affinity](/positioning/close-affinity/) > The three core values
...
- Buber's belonging stays dyadic. Sandel and MacIntyre develop belonging as constitutive without developing a metaphysics from it.
- Nagel's privacy stays epistemological — what we cannot know — rather than becoming a value that generates a world.
