...
lastmod: 2026-05-11
title: "Pluralism"
description: "Dimensions of pluralism across philosophy — metaphysical, epistemological, linguistic, value, political — and where interrelational pluralism sits among them."
---

[Home](/) > [Positioning](/positioning/) > [Close affinity](/positioning/close-affinity/) > Pluralism
...
**[William Connolly](/positioning/persons/c/connolly/)** separates *pluralism* (existing diversity) from *pluralisation* (the emergence of new diversity). This is the closest existing move to what "interrelational" adds. Most pluralisms describe a state — there are many. Connolly sees a process — diversity is produced. The distinction matters: a pluralism that only describes what is already there has no account of how the many came to be or why they keep growing.
...
The dimensions feel separate because each tradition reached for the strand its own concerns demanded — metaphysics for substance, epistemology for method, politics for power. But the underlying structural observation is the same one, surfacing at different angles: many, none privileged, interconnected. Interrelational pluralism reads these strands together, recognising the structural observation each reaches from its own angle, derived from the [seed](/seed/interrelational-pluralism/).

See the [structural trajectory](/positioning/seed/interrelational-pluralism/) for how the mechanism itself shows up across frameworks.
