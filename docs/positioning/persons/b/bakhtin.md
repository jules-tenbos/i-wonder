...
description: "Russian philosopher and literary theorist — dialogism, the utterance, polyphony, carnival, outsideness, the unfinalisability of the self."
---

[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Bakhtin
...
[*Rabelais and His World*](https://en.wikipedia.org/wiki/Rabelais_and_His_World) (written 1940s, published 1965) develops the concept of carnival — the medieval and Renaissance tradition of festivals in which social hierarchies are suspended, the body and its functions are celebrated, and the sacred is profaned. Carnival is not merely entertainment; it is a lived alternative to official culture. In carnival, the king is dethroned, the fool is crowned, high and low are reversed. The reversal is temporary — carnival does not overthrow the social order — but it exposes the order's contingency: things could be otherwise.
...
- [*Problems of Dostoevsky's Poetics*](https://en.wikipedia.org/wiki/Problems_of_Dostoevsky%27s_Poetics) (1929/1963) — the polyphonic novel, dialogism, the unfinalisability of the character
- *The Dialogic Imagination* (essays 1930s–40s, published 1975) — heteroglossia, chronotope, the discourse of the novel
- [*Rabelais and His World*](https://en.wikipedia.org/wiki/Rabelais_and_His_World) (written 1940s, published 1965) — carnival, the grotesque body, laughter as philosophical category
