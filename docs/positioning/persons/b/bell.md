...
layout: default
lastmod: 2026-05-28
title: "John Bell (1928–1990)"
description: "Irish physicist — Bell's theorem, Bell inequalities, the foundations of quantum mechanics, the impossibility of local hidden variables, the measurement problem."
---

[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Bell

# John Bell (1928–1990)

Bell proved that quantum mechanics is incompatible with local realism. His theorem (1964) — and the experimentally testable inequalities it generates — showed that no theory in which physical properties exist independently of measurement (realism) and in which influences cannot travel faster than light (locality) can reproduce all the predictions of quantum mechanics. The result refuted [Einstein](/positioning/persons/e/einstein/)'s preferred resolution of the EPR paradox — local hidden variables — without thereby settling the interpretation question that the Einstein-[Bohr](/positioning/persons/b/bohr/) dispute had opened. Nature violates Bell's inequality, as [Alain Aspect](https://en.wikipedia.org/wiki/Alain_Aspect)'s experiments (1982) and subsequent tests have confirmed. The theorem does not dictate which element of local realism fails — locality, realism, or some assumption about the independence of measurement settings — and the choice among the options maps onto the interpretations of quantum mechanics that remain in contention.

---

## Life

Born 28 June 1928 in Belfast, Northern Ireland, into a working-class family. His father was a horse dealer. Educated at the Belfast Technical High School, Queen's University Belfast (BSc in experimental physics, 1948; BSc in mathematical physics, 1949), and the University of Birmingham (PhD, 1956), under [Rudolf Peierls](https://en.wikipedia.org/wiki/Rudolf_Peierls), on the CPT theorem in quantum field theory.
...
**The inequality.** In the simplest form (the CHSH inequality, a generalisation by [Clauser](https://en.wikipedia.org/wiki/John_Clauser), Horne, [Shimony](https://en.wikipedia.org/wiki/Abner_Shimony), and Holt, 1969): the correlation between measurements on entangled particles, summed over four combinations of measurement settings, must be bounded by 2 in any local realistic theory. Quantum mechanics predicts a maximum of 2√2 ≈ 2.83. Experiments consistently observe values near the quantum-mechanical prediction, violating the local-realist bound.
...
- Abandon locality → non-local hidden variables ([Bohm](/positioning/persons/b/bohm/)'s theory)
...
- Reinterpret the framework → relational quantum mechanics ([Rovelli](/positioning/persons/r/rovelli/)), many-worlds ([Everett](/positioning/persons/e/everett/))
...
The experimental tests of Bell's inequality have been progressively refined — closing the "locality loophole" ([Aspect](https://en.wikipedia.org/wiki/Alain_Aspect), 1982), the "detection loophole" (Giustina et al., Hensen et al., 2015), and finally both simultaneously in "loophole-free" tests. The superdeterminism loophole — the possibility that the choice of measurement settings is correlated with the hidden variables — remains in principle unclosable by experiment, since any experimental test must assume that the settings are freely chosen. Whether superdeterminism is a live option or a philosophical dead end is debated.
