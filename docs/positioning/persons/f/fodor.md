...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Fodor
...
**Against adaptationism.** *What Darwin Got Wrong* (2010, with [Massimo Piattelli-Palmarini](https://en.wikipedia.org/wiki/Massimo_Piattelli-Palmarini)) extended the critique from psychology to biology. Fodor and Piattelli-Palmarini argued that natural selection cannot do the explanatory work adaptationism claims for it, because selection cannot distinguish between traits and their correlated properties — the selection-for/selection-of problem that [Sober](/positioning/persons/s/sober/) had analysed. The book was widely criticised by biologists and philosophers of biology, who argued that Fodor had misunderstood the structure of selectionist explanation. [Dennett](/positioning/persons/d/dennett/), [Lewontin](/positioning/persons/l/lewontin/), and [Elliot Sober](/positioning/persons/s/sober/) all rejected the argument, though for different reasons. The book is the most contested work of Fodor's career.
...
- *The Language of Thought* (Thomas Y. Crowell, 1975) — mental representations have language-like structure; the computational theory of mind
- *The Modularity of Mind* (MIT Press, 1983) — input systems as modules; the distinction between modular periphery and unencapsulated centre
- *Psychosemantics: The Problem of Meaning in the Philosophy of Mind* (MIT Press, 1987) — how mental representations get their content
- *The Mind Doesn't Work That Way: The Scope and Limits of Computational Psychology* (MIT Press, 2000) — the critique of massive modularity
- Fodor, J. and M. Piattelli-Palmarini, *What Darwin Got Wrong* (Farrar, Straus and Giroux, 2010) — the critique of adaptationism
