...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Saussure

# Ferdinand de Saussure (1857–1913)

Saussure matters to SPLectrum because he was the first to treat language as a system of relations rather than a collection of labels. His differential sign — meaning through difference, not through content — is the linguistic expression of what the [seed](/seed/)'s P1 states philosophically: language is relational. And his insight that different languages carve up reality differently resonates with P2: there is no pre-linguistic reality waiting to be labelled. But Saussure kept the system static and abstract (*langue*), separate from the living act of speech (*parole*). [Wittgenstein](/positioning/persons/w/wittgenstein/)'s language games and [Merleau-Ponty](/positioning/persons/m/merleau-ponty/)'s embodied expression both move beyond this — and SPLectrum follows them into the lived, the shared, and the evolving. Saussure also stands at the origin of [structuralism](/positioning/subjects/s/structuralism/), whose method shaped a generation before being challenged by the very thinkers SPLectrum draws on.
...
Saussure's system is synchronic — a snapshot. It describes how signs relate at a moment in time but has nothing to say about how the system evolves, how new meanings arise, how languages grow in complexity. The living act of speech (*parole*) is set aside as individual variation, not part of the system. And the system is closed: *langue* is a self-contained structure, not embedded in practice or life. [Wittgenstein](/positioning/persons/w/wittgenstein/) opened the system into language games — plural, embedded in activity, evolving. [Merleau-Ponty](/positioning/persons/m/merleau-ponty/) put the body back in. SPLectrum's seed takes the relational insight Saussure established and extends it: language is not just differential (P1) but lived (P2), shared (P3), interrelational (P4), and growing (P5). The static system becomes a living web.

---

## Key works

- [*Course in General Linguistics*](https://en.wikipedia.org/wiki/Course_in_General_Linguistics) (1916, posthumous) — reconstructed from student notes; the foundation of structural linguistics
...
See also: [Structuralism](/positioning/subjects/s/structuralism/) · [The seed and Philosophy](/seed/philosophical/) · [Being as Tension](/positioning/seed/being-as-tension/)
