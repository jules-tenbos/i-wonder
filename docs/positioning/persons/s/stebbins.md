...
layout: default
lastmod: 2026-05-27
title: "G. Ledyard Stebbins (1906–2000)"
description: "American botanist and geneticist — Variation and Evolution in Plants, the integration of botany into the Modern Synthesis, polyploidy, hybridisation, plant speciation."
---

[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Stebbins

# G. Ledyard Stebbins (1906–2000)

Stebbins was a botanist and geneticist whose *Variation and Evolution in Plants* (1950) brought botany into the Modern Synthesis. The Synthesis had been built largely from animal examples — [Dobzhansky](/positioning/persons/d/dobzhansky/)'s *Drosophila*, [Mayr](/positioning/persons/m/mayr/)'s birds, [Simpson](/positioning/persons/s/simpson/)'s mammals — and plant evolution had remained peripheral. Stebbins showed that the same mechanisms (natural selection, genetic drift, geographic isolation) operate in plants, but with complications that have no direct parallel in most animal groups: polyploidy (whole-genome duplication) can produce reproductive isolation in a single generation, and hybridisation between species is common, often creative, and blurs the species boundaries that the Synthesis's animal-focused architects had drawn sharply.
...
Stebbins was a field botanist as well as a geneticist — he knew the California flora in detail and conducted extensive fieldwork on grasses, particularly the genus *Crepis* (hawksbeard). His botanical knowledge was not abstract; the theoretical arguments in *Variation and Evolution in Plants* are grounded in specific plant systems he had studied first-hand. Co-authored the widely used textbook *Evolution* (1977) with Dobzhansky, [Francisco Ayala](https://en.wikipedia.org/wiki/Francisco_J._Ayala), and [James Valentine](https://en.wikipedia.org/wiki/James_W._Valentine). Died 19 January 2000 in Davis, California.
...
- *Variation and Evolution in Plants* (Columbia, 1950) — botany integrated into the Modern Synthesis
- *The Basis of Progressive Evolution* (University of North Carolina Press, 1969) — directional trends in evolution
- Dobzhansky, T., Ayala, F. J., Stebbins, G. L., and Valentine, J. W., *Evolution* (W. H. Freeman, 1977) — co-authored textbook
- *Flowering Plants: Evolution above the Species Level* (Harvard, 1974) — the radiation of angiosperms

---

See also: [Darwinism](/positioning/subjects/d/darwinism/) · [Dobzhansky](/positioning/persons/d/dobzhansky/) · [Mayr](/positioning/persons/m/mayr/) · [Mendel](/positioning/persons/m/mendel/)
