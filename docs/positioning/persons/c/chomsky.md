...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Chomsky
...
Chomsky is a principal architect of the **cognitive revolution** — the displacement of behaviourism as psychology's dominant framework and the return of mind, internal representation, and mental structure as proper objects of science. His 1959 **review of B.F. [Skinner](/positioning/persons/s/skinner/)'s *Verbal Behavior*** argued that operant conditioning could not account for the speed, productivity, and creativity of language acquisition, and is widely taken as a turning point in the decline of [behaviourism](/positioning/subjects/b/behaviourism/); it is best understood as one decisive node in that larger shift rather than its whole.

He has been explicit in reviving **rationalist and nativist** themes against empiricism. *Cartesian Linguistics* (1966) traces a lineage from [Descartes](/positioning/persons/d/descartes/) and the Port-Royal grammarians through Humboldt — thinkers for whom language reveals the structure of mind — and recovers their "creative aspect of language use" as rooted in an innate rule system. He has engaged the major philosophers of his era: [Quine](/positioning/persons/q/quine/) on meaning and the indeterminacy of translation, [Jean Piaget](https://plato.stanford.edu/entries/piaget/) in the 1975 Royaumont debate on innateness versus developmental construction, and [Putnam](/positioning/persons/p/putnam/), [Goodman](/positioning/persons/g/goodman/), and [Dennett](/positioning/persons/d/dennett/) on mind and meaning. On the mind-body problem he is deflationary — arguing that the "body" half dissolved once physics outgrew classical mechanics — and he distinguishes *problems*, which science can solve, from *mysteries* such as consciousness, which may lie beyond it; he is sceptical of strong AI while remaining naturalistic.
...
- [*Manufacturing Consent*](https://en.wikipedia.org/wiki/Manufacturing_Consent) (1988, with Edward Herman) — the propaganda model of media
- [*The Minimalist Program*](https://en.wikipedia.org/wiki/Minimalist_program) (1995) — the search for the simplest characterisation of the language faculty
