...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Heraclitus

# Heraclitus (c. 535–c. 475 BCE)

Heraclitus matters to SPLectrum because he put constancy-through-flux at the centre of thinking two and a half thousand years ago. His river stays the same *because* the water flows — not despite it. That structural insight converges with [historicity](/seed/historicity/): what persists is not what stays put but what retains its form through change. His *logos* — the account that holds the flux together — sits close to where SPLectrum puts language.
...
- *"Nature loves to hide."* (B123)
- *"Although this logos holds always, humans always prove unable to understand it."* (B1)
- *"It is wise to listen not to me but to the logos, and to agree that all things are one."* (B50)
- *"A person's character is their daimon."* (B119)
- *"The waking share one common world, but the sleeping turn aside each into a world of their own."* (B89)
