...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Veblen
...
Undergraduate at Carleton College, Minnesota (BA, 1880), then Johns Hopkins and Yale (PhD in philosophy, 1884, under [William Graham Sumner](https://en.wikipedia.org/wiki/William_Graham_Sumner) — the Social Darwinist whose politics Veblen would later oppose). Unable to find an academic position for seven years after his PhD. Finally appointed at the University of Chicago (1892), where he edited the *Journal of Political Economy* and wrote *The Theory of the Leisure Class*. The book was a success — partly as economics, partly as social satire — and established Veblen's reputation.
...
The question was prescient. The evolutionary economics that [Nelson and Winter](https://en.wikipedia.org/wiki/An_Evolutionary_Theory_of_Economic_Change) developed eighty years later, and the complexity economics that [W. Brian Arthur](/positioning/persons/a/arthur/) and the Santa Fe Institute pursued, are direct responses to the question Veblen posed — though they use mathematical tools Veblen did not have.
...
The social satire in *The Theory of the Leisure Class* has proved more durable than the institutional economics — the book is still read for its observations about status, consumption, and display, while Veblen's formal economic contributions are studied mainly by historians of economics. Whether this reflects the enduring quality of the satire or the limited influence of the economics is a question that divides his reception. [John Kenneth Galbraith](https://en.wikipedia.org/wiki/John_Kenneth_Galbraith), who championed Veblen, regarded him as the most important American economist; most mainstream economists regard him as a sociologist of capitalism rather than a contributor to economic theory.

Veblen's prose style — ironic, circuitous, mock-solemn — is itself a barrier to influence. The style is deliberate (Veblen was performing the anthropological detachment he advocated), but it can read as obscurity or self-indulgence. Whether the style is an instrument of analysis or a substitute for it is a recurring question. [C. Wright Mills](https://en.wikipedia.org/wiki/C._Wright_Mills) observed that "Veblen is the best critic of America that America has produced" but also that his work "contains too much jargon and precious phrasing."

---

## Key works

- Veblen, T., "Why is Economics Not an Evolutionary Science?" *Quarterly Journal of Economics* 12 (1898) — the programmatic essay
- *The Theory of the Leisure Class: An Economic Study of Institutions* (Macmillan, 1899) — conspicuous consumption, the leisure class, pecuniary emulation
- *The Theory of Business Enterprise* (Scribner's, 1904) — the conflict between industry (production) and business (finance)
- *The Instinct of Workmanship and the State of the Industrial Arts* (Macmillan, 1914) — the productive instinct vs. the pecuniary habits
- *The Engineers and the Price System* (Huebsch, 1921) — the potential for a technocratic alternative to capitalist management
