...
- [*The Origins of Order*](https://en.wikipedia.org/wiki/The_Origins_of_Order) (Oxford, 1993) — the technical statement: Boolean networks, autocatalytic sets, NK landscapes
- *At Home in the Universe* (Oxford, 1995) — general-audience presentation
- *Investigations* (Oxford, 2000) — the adjacent possible, the turn toward philosophy
- *Reinventing the Sacred* (Basic Books, 2008) — the "God of creativity"
- *A World Beyond Physics* (Oxford, 2019) — no entailing laws, the biosphere beyond reduction
