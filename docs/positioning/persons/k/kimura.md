...
layout: default
lastmod: 2026-05-26
title: "Motoo Kimura (1924–1994)"
description: "Japanese population geneticist — the neutral theory of molecular evolution, diffusion equations in genetics, the molecular clock, and the argument that most evolutionary change at the molecular level is not adaptive."
---

[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Kimura
...
- Kimura, M., "Evolutionary rate at the molecular level," *Nature* 217 (1968) — the founding paper of neutral theory
- Kimura, M., "The number of heterozygous nucleotide sites maintained in a finite population due to steady flux of mutations," *Genetics* 61 (1969) — the infinite sites model
- Kimura, M., & Ohta, T., "Protein polymorphism as a phase of molecular evolution," *Nature* 229 (1971) — connecting polymorphism to neutral substitution
- *The Neutral Theory of Molecular Evolution* (Cambridge, 1983) — the definitive book-length treatment
- Kimura, M., "The neutral theory of molecular evolution: A review of recent evidence," *Japanese Journal of Genetics* 66 (1991) — late summary of the state of the field

---

See also: [Darwinism](/positioning/subjects/d/darwinism/) · [Wright](/positioning/persons/w/wright/) · [Haldane](/positioning/persons/h/haldane/) · [Lewontin](/positioning/persons/l/lewontin/) · [Fisher](/positioning/persons/f/fisher/)
