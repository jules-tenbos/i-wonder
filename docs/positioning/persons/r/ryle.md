...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Ryle
...
- "Systematically Misleading Expressions" (1932) — dissolving philosophical problems through the logic of ordinary language
- [*The Concept of Mind*](https://en.wikipedia.org/wiki/The_Concept_of_Mind) (1949) — the Ghost in the Machine, the category mistake, dispositions, knowing-how and knowing-that
- *Dilemmas* (1954) — essays on conceptual puzzles
- *Plato's Progress* (1966) — a study of the Platonic dialogues
- *On Thinking* (1979, posthumous) — late essays on thinking and reasoning
