...
Fellow of the Royal Society (1896). Darwin Medal (1898). Founded *Biometrika* in 1901, with [W. F. R. Weldon](https://en.wikipedia.org/wiki/W._F._R._Weldon) and Galton, as a journal for the statistical study of biological problems — partly in response to the Royal Society's refusal to publish their longer statistical papers. Died 27 April 1936 in Coldharbour, Surrey.
...
- *The Grammar of Science* (Walter Scott, 1892; 2nd ed. 1900; 3rd ed. 1911) — philosophy of science, strict positivism, science as description of correlations
- Pearson, K., "On the criterion that a given system of deviations from the probable in the case of a correlated system of variables is such that it can be reasonably supposed to have arisen from random sampling," *Philosophical Magazine* 50 (1900) — the chi-squared test
- Pearson, K., "On the laws of inheritance in man," *Biometrika* 3 (1904) — the law of ancestral heredity applied to human populations
- *The Life, Letters and Labours of Francis Galton* (3 vols., Cambridge, 1914–30) — biography of Galton, also a primary source for the history of biometry and eugenics
