...
*Order Out of Chaos: Man's New Dialogue with Nature* (Prigogine and [Isabelle Stengers](/positioning/persons/s/stengers/), 1984) is the synthesis for a general audience. The book argues that the Newtonian worldview — deterministic, time-reversible, equilibrium-seeking — is a special case, not the general picture. The general picture is one of irreversibility, instability, and the creative production of novelty through far-from-equilibrium dynamics.
...
The book appeared in 1984, coincidentally the year the Santa Fe Institute was founded. The overlap is more than chronological: Prigogine's demonstration that order arises from non-equilibrium dynamics is one of the intellectual conditions that made [CAS](/positioning/subjects/c/complex-adaptive-systems/) research possible.
...
- *Introduction to Thermodynamics of Irreversible Processes* (Wiley, 1955; 3rd ed. 1967) — the technical foundation of non-equilibrium thermodynamics.
- *From Being to Becoming: Time and Complexity in the Physical Sciences* (W.H. Freeman, 1980) — irreversibility as fundamental; the philosophical turn.
- *Order Out of Chaos: Man's New Dialogue with Nature* (with [Stengers](/positioning/persons/s/stengers/), Bantam, 1984) — the general-audience synthesis: dissipative structures, the new dialogue between science and philosophy.
- *The End of Certainty: Time, Chaos, and the New Laws of Nature* (Free Press, 1997) — the mature argument for intrinsic irreversibility.
