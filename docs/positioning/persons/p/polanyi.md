...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Polanyi

# Michael Polanyi (1891–1976)

Polanyi matters to SPLectrum because he showed that knowing always exceeds what can be said — and that this is not a defect but a condition of all understanding. "We can know more than we can tell" is the epistemological counterpart of the [seed](/seed/)'s P2: the subject's experience of reality goes beyond what language can share. His indwelling — extending the self into tools and practices until they become part of perception — resonates with [Merleau-Ponty](/positioning/persons/m/merleau-ponty/)'s habitual body and with SPLectrum's treatment of language as lived medium. His republic of science — coordination through mutual adjustment, not central planning — prefigures SPLectrum's P4 (equal standing) and [Ostrom](/positioning/persons/o/ostrom/)'s polycentric governance. And his ontological emergence connects to P5: genuinely irreducible higher levels, complexity growing in expression.
...
Polanyi showed that knowing is personal, tacit, embodied — but he kept the knower individual. His republic of science describes mutual adjustment, not the constitution of shared reality through language. How the tacit becomes shared, how communities build a vocabulary that mediates between what each member knows privately and what the group holds in common (P3) — these are not his questions. His from-to structure describes how one subject integrates clues; SPLectrum's P3 asks how subjects integrate with each other. And his emergence, though powerful, stays ontological — it does not address how higher levels are constituted linguistically, how the language of the higher level relates to the language of the lower (P4). SPLectrum takes Polanyi's tacit dimension seriously and asks: what happens when tacit knowledge meets shared language?

---

## Key works

- [*Personal Knowledge*](https://en.wikipedia.org/wiki/Personal_Knowledge) (1958) — tacit knowing, commitment, the personal in all knowledge
- *The Republic of Science* (1962) — self-coordination in scientific communities, against central planning of research
- [*The Tacit Dimension*](https://en.wikipedia.org/wiki/The_Tacit_Dimension) (1966) — the concise statement: "we can know more than we can tell"
