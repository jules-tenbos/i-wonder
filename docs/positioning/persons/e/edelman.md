...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Edelman
...
Born 1 July 1929 in Ozone Park, Queens, New York. Undergraduate at Ursinus College (BS, 1950). MD from the University of Pennsylvania (1954). PhD at Rockefeller University (1960). Nobel Prize in Physiology or Medicine (1972, shared with [Rodney Porter](https://en.wikipedia.org/wiki/Rodney_Robert_Porter)) for determining the chemical structure of antibodies — showing that antibodies are proteins composed of two heavy chains and two light chains, with variable regions that determine antigen specificity.
...
- Edelman, G. M., "Antibody structure and molecular immunology," *Nobel Lecture* (1972) — the antibody-structure work
- *Neural Darwinism: The Theory of Neuronal Group Selection* (Basic Books, 1987) — the theory stated
- *The Remembered Present: A Biological Theory of Consciousness* (Basic Books, 1989) — consciousness through reentrant signalling
- *Bright Air, Brilliant Fire: On the Matter of the Mind* (Basic Books, 1992) — the popular account
- Edelman, G. M. and G. Tononi, *A Universe of Consciousness: How Matter Becomes Imagination* (Basic Books, 2000) — integration and complexity
