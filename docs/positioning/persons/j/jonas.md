...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Jonas

# Hans Jonas (1903–1993)

Jonas matters to SPLectrum because he extended [phenomenology](/positioning/subjects/p/phenomenology/) into biology — showing that the properties the seed takes as foundational are visible from the simplest cell. Metabolism as self-constitution is P0 at the biological level: a boundary sustained from within, being differentiated from its other. Inwardness — something mattering to the organism — is the first glimmer of P2: a subject experiencing reality through its own medium. And the inseparability of freedom and necessity — the organism must maintain itself or cease to be — connects to the dynamic character of the [seed](/seed/): language is not static but sustained through ongoing activity. Jonas closes the gap between the living and the philosophical that [Descartes](/positioning/persons/d/descartes/)' mind-body split had opened.
...
**The phenomenon of life.** Jonas argues that life is not a special case of physics but a phenomenon in its own right, requiring its own categories. Against the mechanistic tradition from [Descartes](/positioning/persons/d/descartes/) onward — treating organisms as complicated machines — Jonas insists that the properties that matter are visible from the simplest cell: inwardness, neediness, self-concern. To treat them as epiphenomena of material processes is to miss what is distinctively alive about the living.
...
Jonas showed that selfhood begins at the cell — but he stayed with the individual organism. The relational space between organisms, the constitution of shared reality through language (P3), the interrelation of languages (P4) — these are not his questions. His inwardness is singular: each organism has its own stake, its own perspective. How organisms form communities, how shared meaning emerges from individual self-constitution, how the web grows in complexity (P5) — these need other sources. [Merleau-Ponty](/positioning/persons/m/merleau-ponty/)'s intercorporeality picks up where Jonas's inwardness stops; SPLectrum's seed extends both into the relational and the shared.

---

## Key works

- [*The Gnostic Religion*](https://en.wikipedia.org/wiki/The_Gnostic_Religion) (1958) — Gnosticism, dualism, the self as alien to matter
- [*The Phenomenon of Life*](https://en.wikipedia.org/wiki/The_Phenomenon_of_Life) (1966) — metabolism, inwardness, the organism as self-constituting
- [*The Imperative of Responsibility*](https://en.wikipedia.org/wiki/The_Imperative_of_Responsibility) (1979) — ethics of the future, the precautionary principle
