...
In both tournaments, the winner was tit-for-tat, submitted by [Anatol Rapoport](https://en.wikipedia.org/wiki/Anatol_Rapoport). The strategy is the simplest possible: cooperate on the first move; thereafter, do whatever the other player did on the previous move. It is nice (never defects first), retaliatory (punishes defection immediately), forgiving (returns to cooperation as soon as the other player does), and transparent (its logic is immediately legible to the other player).
...
- *The Evolution of Cooperation* (Basic Books, 1984) — the prisoner's dilemma tournaments, tit-for-tat, the conditions for cooperation.
- "The Evolution of Cooperation" (with William Hamilton, *Science*, 1981) — the biological extension: cooperation through reciprocity as an evolutionarily stable strategy.
- *The Complexity of Cooperation: Agent-Based Models of Competition and Collaboration* (Princeton University Press, 1997) — cultural dissemination, norms, agent-based extensions.
