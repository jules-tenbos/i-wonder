...
layout: default
lastmod: 2026-05-28
title: "John Archibald Wheeler (1911–2008)"
description: "American physicist — 'it from bit', geometrodynamics, the delayed-choice experiment, the participatory universe, nuclear physics, general relativity, quantum gravity."
---

[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Wheeler (John Archibald)

# John Archibald Wheeler (1911–2008)

Wheeler was one of the most influential physicists of the twentieth century — not primarily for any single discovery but for the questions he posed, the students he trained, and the conceptual frameworks he introduced. He coined or popularised the terms "black hole," "wormhole," "quantum foam," and "it from bit." He supervised [Everett](/positioning/persons/e/everett/)'s thesis on the relative-state formulation of quantum mechanics, co-developed the Wheeler-DeWitt equation (with [Bryce DeWitt](https://en.wikipedia.org/wiki/Bryce_DeWitt)) for quantum gravity, and introduced the delayed-choice experiment — the thought experiment that sharpened the question of what measurement means in quantum mechanics. His later work on "it from bit" — the proposal that information is the fundamental substance of reality, and that the physical world derives from yes/no questions — placed him at the origin of the information-theoretic turn in the foundations of physics. Wheeler also made foundational contributions to nuclear physics (the liquid-drop model of nuclear fission, with [Bohr](/positioning/persons/b/bohr/)) and general relativity (gravitational collapse, geometrodynamics).
...
At Princeton, Wheeler built the most consequential PhD programme in theoretical physics. His students include [Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman) (PhD 1942), [Hugh Everett](/positioning/persons/e/everett/) (1957), [Charles Misner](https://en.wikipedia.org/wiki/Charles_W._Misner) (1957), [Kip Thorne](https://en.wikipedia.org/wiki/Kip_Thorne) (1965), [Robert Geroch](https://en.wikipedia.org/wiki/Robert_Geroch) (1967), and [Bryce DeWitt](https://en.wikipedia.org/wiki/Bryce_DeWitt) (though DeWitt's formal advisor was different, he worked closely with Wheeler). *Gravitation* (1973, with Misner and Thorne) — the thousand-page textbook known as "MTW" — trained a generation in general relativity.
...
- Bohr, N., & Wheeler, J. A., "The Mechanism of Nuclear Fission," *Physical Review* 56 (1939) — the liquid-drop model
- Wheeler, J. A., "Geometrodynamics," in *Relativity, Groups and Topology* (Gordon and Breach, 1964) — the spacetime-geometry programme
- DeWitt, B. S., "Quantum Theory of Gravity. I. The Canonical Theory," *Physical Review* 160 (1967) — the Wheeler-DeWitt equation (DeWitt's formulation of Wheeler's programme)
- Misner, C. W., Thorne, K. S., & Wheeler, J. A., *Gravitation* (Freeman, 1973) — the textbook
- Wheeler, J. A., "Information, Physics, Quantum: The Search for Links," in *Proceedings of the 3rd International Symposium on Foundations of Quantum Mechanics* (1989) — "it from bit"
