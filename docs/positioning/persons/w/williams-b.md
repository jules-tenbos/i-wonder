...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Williams (Bernard)
...
Williams served on public bodies including the Committee on Obscenity and Film Censorship (the "Williams Report," 1979). He was married to [Shirley Williams](https://en.wikipedia.org/wiki/Shirley_Williams), the politician, from 1955 to 1974. Knighted in 1999. Died 10 June 2003 in Rome.

---

## The critique of utilitarianism

*Utilitarianism: For and Against* (1973, with [J. J. C. Smart](https://en.wikipedia.org/wiki/J._J._C._Smart)). Williams's contribution ("A Critique of Utilitarianism") introduced two arguments that permanently damaged the utilitarian programme.
...
**Political realism.** Developed in the posthumous collection *In the Beginning Was the Deed* (2005). Williams argued that political philosophy has been dominated by a "political moralism" — the attempt to derive political conclusions from prior moral principles (as in [Rawls](https://en.wikipedia.org/wiki/John_Rawls)'s theory of justice). The alternative is political realism: the recognition that politics has its own distinctive questions — the Basic Legitimation Demand (what makes a state's authority legitimate?) — that cannot be answered by applying moral theory to the political domain. The state must offer a justification for its power that makes sense to the people over whom it is exercised; a justification that does not make sense to them is not merely unfair but illegitimate. The political-realism strand has been among the most influential parts of Williams's legacy in recent political theory.

---

## Where Williams stops

The destructive arguments are powerful, but the absence of a constructive alternative has been a persistent criticism. If utilitarianism, Kantianism, and neo-Aristotelianism all fail, what remains? Williams's answer — the ethical life as lived from within, thick ethical concepts, the rejection of system — has been read as sophisticated common sense or as a counsel of philosophical despair. [Martha Nussbaum](https://en.wikipedia.org/wiki/Martha_Nussbaum), [John McDowell](https://en.wikipedia.org/wiki/John_McDowell), and others have argued that the thick-concepts approach can be developed into a positive ethical framework; Williams resisted the development, regarding the impulse to systematise as the disease he was diagnosing.

The internal-reasons thesis has been contested on multiple fronts. [John McDowell](https://en.wikipedia.org/wiki/John_McDowell) and [Christine Korsgaard](https://en.wikipedia.org/wiki/Christine_Korsgaard) have argued that the thesis misconstrues the relationship between reason and motivation — that rational reflection can generate new motivations rather than merely reorganising existing ones. If that is right, external reasons are possible after all, and the corrosive implications for moral theory are blocked. Williams maintained his position; the debate is unresolved and may be unresolvable, since it turns on what counts as a genuine deliberative route from an existing motivation to a new one — a question about the boundaries of practical reasoning that resists formal resolution.

The critique of the ergon argument — that there is no human function — is the point at which Williams's programme intersects most sharply with [Foot](/positioning/persons/f/foot/)'s natural-goodness project. Foot accepted the challenge: her *Natural Goodness* (2001) attempted to rehabilitate the ergon claim by embedding it in a broader evaluative framework for living things. Whether Foot's response answers Williams's objection — whether the natural-historical generics about human life have the evaluative force that a knife's purpose has — is the live question in contemporary virtue ethics.

---

## Key works

- Williams, B., "A Critique of Utilitarianism," in J. J. C. Smart & B. Williams, *Utilitarianism: For and Against* (Cambridge, 1973) — integrity, negative responsibility
- Williams, B., "Internal and External Reasons," in *Moral Luck* (Cambridge, 1981) — the internal-reasons thesis
- Williams, B., "Moral Luck," in *Moral Luck* (Cambridge, 1981) — the problem of moral luck
- *Ethics and the Limits of Philosophy* (Fontana, 1985) — the critique of moral theory, thick concepts
- *Shame and Necessity* (California, 1993) — Greek ethics reread, the limits of progressivism about moral concepts
- *Truth and Truthfulness: An Essay in Genealogy* (Princeton, 2002) — the virtues of truth, accuracy and sincerity
- *In the Beginning Was the Deed: Realism and Moralism in Political Argument* (Princeton, 2005, posthumous) — political realism, the Basic Legitimation Demand
