...
Whitehead's system is speculative and totalising in a way SPLectrum's seed isn't built for. It aims to describe everything: every actual occasion, from an electron to God, fits one categorical scheme. The ambition is magnificent and is also the problem. He stays with the individual occasion as the unit of analysis — the social constitution of shared reality through language, where P3 lives, isn't his question. And his God, however unconventional, introduces a principle of order the SPLectrum seed doesn't ask for.
