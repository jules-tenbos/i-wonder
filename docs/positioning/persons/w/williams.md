...
Williams' framework is gene-centric and methodologically adaptationist: it demands that every claim of adaptation meet a gene-level selectionist standard. The parsimony principle — do not invoke group selection when individual selection suffices — is a rule of argument. It tells you how to evaluate claims, not what processes exist. The revival of multilevel selection theory (Sober and D. S. Wilson 1998, and later including [E. O. Wilson's](/positioning/persons/w/wilson/) own late-career turn to group selection) reopened the question Williams had largely closed, arguing that the issue is not which level is real but how selection at multiple levels interacts in particular cases. Williams' programme provides the critical standard but not the multi-level framework that subsequent work has built around it.

---

## Key works

- Williams, G. C., "Pleiotropy, natural selection, and the evolution of senescence," *Evolution* 11 (1957) — antagonistic pleiotropy, the declining force of selection with age
- *Adaptation and Natural Selection: A Critique of Some Current Evolutionary Thought* (Princeton, 1966) — the gene-level critique of group selection
- *Sex and Evolution* (Princeton, 1975) — the cost of sex, the lottery and tangled-bank models
- *Natural Selection: Domains, Levels, and Challenges* (Oxford, 1992) — a refined statement of the selectionist framework
- Nesse, R. M., & Williams, G. C., *Why We Get Sick: The New Science of Darwinian Medicine* (Times Books, 1994) — evolutionary medicine for a general audience
- *The Pony Fish's Glow* (Basic Books, 1997) — popular essays on adaptation and natural history

---

See also: [Darwinism](/positioning/subjects/d/darwinism/) · [Dawkins](/positioning/persons/d/dawkins/) · [Hamilton](/positioning/persons/h/hamilton/) · [Maynard Smith](/positioning/persons/m/maynard-smith/) · [Fisher](/positioning/persons/f/fisher/)
