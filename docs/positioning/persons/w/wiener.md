...
But the concepts survived the fragmentation. Feedback became standard vocabulary across engineering, biology, economics, and management. The second-order cybernetics of [von Foerster](/positioning/persons/v/von-foerster/), [Maturana](/positioning/persons/m/maturana/), and [Varela](/positioning/persons/v/varela/) brought the observer into the system and developed autopoiesis. CAS inherited feedback as a foundational concept while breaking from the homeostatic emphasis toward adaptation and open-ended change.
...
- *Cybernetics: or Control and Communication in the Animal and the Machine* (MIT Press, 1948; 2nd ed. 1961) — the founding text of cybernetics.
- *The Human Use of Human Beings: Cybernetics and Society* (Houghton Mifflin, 1950; revised 1954) — the social and political implications.
- *Extrapolation, Interpolation, and Smoothing of Stationary Time Series* (MIT Press, 1949) — the Wiener filter; known informally as "the yellow peril" for its difficulty and its yellow cover.

---

See also: [Bateson](/positioning/persons/b/bateson/) · [Maturana](/positioning/persons/m/maturana/) · [Varela](/positioning/persons/v/varela/) · [Complex Adaptive Systems](/positioning/subjects/c/complex-adaptive-systems/)
