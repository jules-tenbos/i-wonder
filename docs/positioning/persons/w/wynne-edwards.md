...
layout: default
lastmod: 2026-05-26
title: "V. C. Wynne-Edwards (1906–1997)"
description: "British zoologist — group selection as the explanation for animal social behaviour, Animal Dispersion, population self-regulation, and the debate that reshaped how evolutionary biologists think about the units of selection."
---

[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Wynne-Edwards

# V. C. Wynne-Edwards (1906–1997)

Wynne-Edwards was a zoologist whose *Animal Dispersion in Relation to Social Behaviour* (1962) presented the most systematic case for group selection in twentieth-century biology: the claim that animals regulate their own population densities for the good of the group or species, and that social behaviours — flocking, communal displays, territorial conventions — function as mechanisms of this self-regulation. The book provoked the most consequential units-of-selection debate in the discipline's history. [George C. Williams'](/positioning/persons/w/williams/) *Adaptation and Natural Selection* (1966) was written substantially as a response, arguing that Wynne-Edwards' group-selectionist reasoning was both unnecessary and methodologically careless. The effect of the Williams critique — reinforced by [Hamilton's](/positioning/persons/h/hamilton/) inclusive fitness theory and later by [Dawkins'](/positioning/persons/d/dawkins/) gene-centric framing — was to displace group selection as a respectable explanatory framework for two decades. Wynne-Edwards' book is now remembered primarily as the position that lost, but the debate it provoked reshaped how evolutionary biologists think about selection, adaptation, and the levels at which natural selection operates.
...
The displacement was not permanent. The revival of multilevel selection theory — [David Sloan Wilson](/positioning/persons/w/wilson-ds/) and [Elliott Sober](https://en.wikipedia.org/wiki/Elliott_Sober)'s *Unto Others* (1998), and later [E. O. Wilson's](/positioning/persons/w/wilson/) own late-career turn to group selection — reopened the question Wynne-Edwards had raised, though in a substantially different framework. Contemporary multilevel selection theory does not defend Wynne-Edwards' specific claims about epideictic displays or population self-regulation. It argues that selection can operate at multiple levels simultaneously and that the question is not which level is "real" but how selection at different levels interacts.

Whether Wynne-Edwards was wrong in his specific claims but right that group-level processes matter, or wrong across the board, remains part of the ongoing multilevel selection debate. The [Wilson person page](/positioning/persons/w/wilson/) carries the fuller treatment of the group selection revival.
...
- *Animal Dispersion in Relation to Social Behaviour* (Oliver & Boyd, 1962) — the systematic case for group selection and population self-regulation
- *Evolution Through Group Selection* (Blackwell, 1986) — revised treatment, acknowledging critiques
- Wynne-Edwards, V. C., "Intergroup selection in the evolution of social systems," *Nature* 200 (1963) — shorter statement of the thesis

---

See also: [Darwinism](/positioning/subjects/d/darwinism/) · [Williams](/positioning/persons/w/williams/) · [Hamilton](/positioning/persons/h/hamilton/) · [Dawkins](/positioning/persons/d/dawkins/) · [Wilson](/positioning/persons/w/wilson/)
