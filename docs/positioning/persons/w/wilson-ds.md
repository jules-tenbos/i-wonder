...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Wilson (D. S.)

# David Sloan Wilson (1949–)

Wilson is an evolutionary biologist who, with the philosopher [Elliott Sober](/positioning/persons/s/sober/), revived multilevel selection theory as a respectable framework in evolutionary biology. *Unto Others: The Evolution and Psychology of Unselfish Behavior* (1998) argued that natural selection operates at multiple levels simultaneously — genes, organisms, and groups — and that the question is not which level is "real" but how selection at different levels interacts in particular cases. The argument reopened a question that [George C. Williams](/positioning/persons/w/williams/)' *Adaptation and Natural Selection* (1966) had closed for a generation. Where Williams and [Dawkins](/positioning/persons/d/dawkins/) maintained that gene-level selection is the only level that matters, Wilson and Sober demonstrated that group-level selection can override individual-level selection under specifiable conditions — and that these conditions are met in real biological systems. Wilson has subsequently applied multilevel selection to human evolution, religion, and the design of prosocial institutions.

---

## Life

Born 1949. Son of the novelist [Sloan Wilson](https://en.wikipedia.org/wiki/Sloan_Wilson) (*The Man in the Gray Flannel Suit*). Undergraduate at the University of Rochester. PhD in evolutionary biology at Michigan State University (1975), studying the evolution of group-level traits in the flour beetle *Tribolium*. The doctoral research was empirical: Wilson used artificial selection on beetle groups to demonstrate that traits detrimental to individuals (cannibalism, reduced fecundity) could be selected for or against at the group level, depending on the structure of between-group competition.
...
**Empirical cases.** Wilson has applied the framework to: the evolution of virulence in parasites (virulent strains outcompete within a host but kill the host faster, reducing transmission — group selection among host-level populations favours lower virulence); the evolution of sex ratios (female-biased sex ratios evolve under local mate competition, a group-selection effect); and the major evolutionary transitions ([Maynard Smith](/positioning/persons/m/maynard-smith/) and [Eörs Szathmáry](https://en.wikipedia.org/wiki/Eörs_Szathmáry), 1995), in which formerly competing entities (genes, cells, organisms) become cooperating members of a higher-level unit — a process Wilson interprets as group selection creating new levels of organisation.
...
Wilson's applied work — the Evolution Institute, the Prosocial project — represents a bet that evolutionary science can directly improve human institutions. The bet is contested not only on empirical grounds but on methodological grounds. [Joseph Heath](https://en.wikipedia.org/wiki/Joseph_Heath) has argued that naturalised social science — the attempt to derive policy recommendations from evolutionary models — underestimates the gap between the models and the institutions they are meant to improve, and that the complexity of real-world social systems resists the clean application of group-selection logic. [Stuart West](https://en.wikipedia.org/wiki/Stuart_West) and Gardner, from the inclusive-fitness side, have pressed the further point that the multilevel framework adds institutional complexity without empirical payoff when simpler kin-selection models explain the same phenomena.

---

## Key works

- Wilson, D. S., "A theory of group selection," *Proceedings of the National Academy of Sciences* 72 (1975) — the trait-group model
...
- Wilson, D. S., *Darwin's Cathedral: Evolution, Religion, and the Nature of Society* (University of Chicago Press, 2002) — religion as adaptive group-level trait
- Wilson, D. S., *Does Altruism Exist? Culture, Genes, and the Welfare of Others* (Yale, 2015) — altruism through multilevel selection
- Wilson, D. S., *This View of Life: Completing the Darwinian Revolution* (Pantheon, 2019) — applied evolutionary science
