...
layout: default
lastmod: 2026-05-27
title: "Francis Galton (1822–1911)"
description: "British polymath — coined 'eugenics', regression to the mean, correlation, the biometric programme, hereditary genius, fingerprint identification."
---

[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Galton
...
**The biometric programme.** Galton and Pearson developed the biometric approach: study heredity through the statistical relationships among measurable traits in populations, without assuming a particular mechanism of inheritance. This was a productive research programme, but it put them in conflict with the Mendelians ([William Bateson](/positioning/persons/b/bateson-w/) and others), who argued that heredity operates through discrete factors. The conflict was resolved — mathematically — by Fisher in "The Correlation Between Relatives on the Supposition of Mendelian Inheritance" (1918), which showed that continuous variation is compatible with Mendelian genetics when many genes of small effect are involved.
...
- *Hereditary Genius: An Inquiry into Its Laws and Consequences* (Macmillan, 1869) — the pedigree method, eminent families
- *Inquiries into Human Faculty and Its Development* (Macmillan, 1883) — coined "eugenics," composite photography, anthropometric methods
- *Natural Inheritance* (Macmillan, 1889) — regression, the law of ancestral heredity, the biometric programme
- *Finger Prints* (Macmillan, 1892) — fingerprint classification and identification
- *Essays in Eugenics* (Eugenics Education Society, 1909) — collected essays and lectures on the eugenic programme

---

See also: [Darwin](/positioning/persons/d/darwin/) · [Fisher](/positioning/persons/f/fisher/) · [Darwinism](/positioning/subjects/d/darwinism/)
