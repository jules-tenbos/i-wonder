...
layout: default
lastmod: 2026-05-28
title: "Alexander Grothendieck (1928–2014)"
description: "German-French mathematician — the refounding of algebraic geometry, schemes, topos theory, étale cohomology, the Grothendieck school, Récoltes et Semailles."
---

[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Grothendieck
...
Born 28 March 1928 in Berlin, Germany. His father Alexander Schapiro was a Russian anarchist; his mother Hanka Grothendieck was a German journalist. Both parents were politically active; his father had participated in the Russian Revolution and fought in the Spanish Civil War. After the Nazi rise to power, the family fled to France (1933). During the German occupation, Grothendieck's father was interned at [Le Vernet](https://en.wikipedia.org/wiki/Le_Vernet_(Ari%C3%A8ge)) and then deported to Auschwitz, where he was killed in 1942. Grothendieck and his mother survived the war in southern France; he was interned briefly at the [Rieucros](https://en.wikipedia.org/wiki/Camp_de_Rieucros) camp as a child.

After the war, Grothendieck studied mathematics at the University of Montpellier (1945–48), then moved to Paris, where he attended [Henri Cartan](https://en.wikipedia.org/wiki/Henri_Cartan)'s seminar at the École Normale Supérieure. PhD at the University of Nancy (1953), under [Laurent Schwartz](https://en.wikipedia.org/wiki/Laurent_Schwartz) and [Jean Dieudonné](https://en.wikipedia.org/wiki/Jean_Dieudonné), on topological vector spaces — a subject unrelated to his later work but already displaying his characteristic approach: rebuilding a subject from its foundations rather than solving problems within an existing framework.
...
- Grothendieck, A., "Sur quelques points d'algèbre homologique" (the "Tôhoku paper"), *Tôhoku Mathematical Journal* 9 (1957) — abelian categories, enough injectives
- Grothendieck, A., & Dieudonné, J., *Éléments de géométrie algébrique* (EGA), I–IV (IHÉS, 1960–67) — the systematic foundation
- *Séminaire de Géométrie Algébrique du Bois Marie* (SGA), 1–7 (IHÉS/Springer, 1960–73) — the seminar proceedings, including étale cohomology
- Grothendieck, A., *Esquisse d'un Programme* (1984, circulated in manuscript; published 1997) — the anabelian programme, dessins d'enfants
- Grothendieck, A., *Récoltes et Semailles* (Gallimard, 2022, posthumous) — the autobiographical reflection

---

See also: [Category theory](/positioning/subjects/c/ct/) · [Eilenberg](/positioning/persons/e/eilenberg/) · [Mac Lane](/positioning/persons/m/mac-lane/) · [Lawvere](/positioning/persons/l/lawvere/)
