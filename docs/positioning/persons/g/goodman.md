...
[Nelson Goodman](https://plato.stanford.edu/entries/goodman/) (1906–1998). Philosopher who argued that there is no one true description of the world — there are many, each constructed through a different symbol system. Worldmaking is not discovery of a pre-existing reality but the active construction of versions, each internally coherent but not reducible to each other.

---

## Key concepts

**Ways of worldmaking.** There is no ready-made world that descriptions copy. Worlds are made — through composition, decomposition, weighting, ordering, deletion, supplementation. Science makes one world, art another, everyday perception yet another. Each is a genuine world, not an approximation of a single truth.
...
**The new riddle of induction (grue).** Goodman's thought experiment: define "grue" as green if observed before some future time, blue otherwise. All evidence for "emeralds are green" equally supports "emeralds are grue." The riddle shows that induction depends on which predicates we consider natural — and that naturalness is a feature of our symbol systems, not of the world itself.
