...
- Eilenberg, S. and S. Mac Lane, "General Theory of Natural Equivalences," *Transactions of the American Mathematical Society* 58 (1945) — the founding paper of category theory
- Mac Lane, S., *Homology* (Springer, 1963) — homological algebra from the categorical perspective
- Mac Lane, S., *Categories for the Working Mathematician* (Springer, 1971; 2nd ed. 1998) — the standard textbook
- Mac Lane, S., *Mathematics: Form and Function* (Springer, 1986) — the philosophy of mathematics as structural
- Mac Lane, S. and I. Moerdijk, *Sheaves in Geometry and Logic: A First Introduction to Topos Theory* (Springer, 1992) — toposes as a categorical foundation
