...
The idea of applying game theory to evolutionary biology had been suggested by [Richard Lewontin](/positioning/persons/l/lewontin/) in a 1961 paper. Maynard Smith developed it into a sustained programme around the concept of the evolutionarily stable strategy. The collaboration began when he encountered [George R. Price](https://en.wikipedia.org/wiki/George_R._Price)'s work while peer-reviewing one of Price's papers; together they mathematically formalised the concept.
...
The prokaryote-to-eukaryote transition draws directly on [Lynn Margulis'](/positioning/persons/m/margulis/) endosymbiotic theory — one of Margulis' contributions that the mainstream absorbed. Maynard Smith's relationship with Margulis' broader programme was more adversarial: he was among the sharpest critics of the Gaia hypothesis, arguing that planetary-scale self-regulation implied group selection without a population of planets. The list is not a settled inventory. Szathmáry himself updated it in 2015, removing sex as a transition and adding endosymbiotic events. Other workers — [Richard Michod](https://en.wikipedia.org/wiki/Richard_Michod), [David Queller](https://en.wikipedia.org/wiki/David_Queller), Matthew Herron — have proposed alternative versions. The 1995 framework remains the canonical reference point, but it has itself evolved.
...
- [*The Theory of Evolution*](https://en.wikipedia.org/wiki/The_Theory_of_Evolution_(book)) (1958) — expository textbook
- "The Logic of Animal Conflict," with G. R. Price, *Nature* 246 (1973) — the ESS
- [*The Evolution of Sex*](https://en.wikipedia.org/wiki/The_Evolution_of_Sex) (1978) — the two-fold cost
- [*Evolution and the Theory of Games*](https://en.wikipedia.org/wiki/Evolution_and_the_Theory_of_Games) (1982) — evolutionary game theory
- [*The Major Transitions in Evolution*](https://en.wikipedia.org/wiki/The_Major_Transitions_in_Evolution), with E. Szathmáry (1995) — the transitions framework
- *Animal Signals*, with D. Harper (2003) — honest signalling
