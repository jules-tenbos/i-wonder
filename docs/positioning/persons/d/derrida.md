...
[Home](/) > [Positioning](/positioning/) > [Persons](/positioning/persons/) > Derrida
...
[*Différance*](https://plato.stanford.edu/entries/derrida/) (1968) is Derrida's central neologism — a word that can only be seen, not heard (in French, *différance* and *différence* sound identical). It combines two senses of the French *différer*: to differ (spatial distinction) and to defer (temporal postponement). Meaning is produced through differences between signs (as [Saussure](/positioning/persons/s/saussure/) established — a sign is what the other signs are not), but it is also always deferred — never fully present in any single moment, always referring onward to other signs. The *a* in *différance* marks the displacement: meaning is neither simply present nor simply absent but always in motion, constituted by a play of differences and deferrals that has no origin and no final resting point.
...
The practice is textual and patient: Derrida's major deconstructive readings — of [Plato](/positioning/persons/p/plato/) (*Plato's Pharmacy*), Rousseau (*Of Grammatology*), [Husserl](/positioning/persons/h/husserl/) (*Speech and Phenomena*), [Lévi-Strauss](https://plato.stanford.edu/entries/levi-strauss/) (*Of Grammatology*), Austin (*Limited Inc*) — each works through a specific text in detail, following its internal logic to the point where it turns on itself. The readings are not external critiques brought to a text but developments of what the text already contains.
...
See also: [Saussure](/positioning/persons/s/saussure/) · [Deleuze](/positioning/persons/d/deleuze/) · [Lyotard](/positioning/persons/l/lyotard/) · [Rorty](/positioning/persons/r/rorty/) · [Husserl](/positioning/persons/h/husserl/)
