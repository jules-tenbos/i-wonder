...
Each of these strands deals with an aspect of what SPLectrum calls interrelational pluralism. Where they work within a single dimension — metaphysical, epistemological, ethical, political — SPLectrum aims to develop a unified view across all of them, derived from the [seed](/seed/interrelational-pluralism) and reaching well beyond the anthropocentric approach that most of these thinkers share.
