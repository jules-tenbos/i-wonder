...
[Leda Cosmides](https://en.wikipedia.org/wiki/Leda_Cosmides) and [John Tooby](https://en.wikipedia.org/wiki/John_Tooby)'s research programme, articulated in *The Adapted Mind* (1992), proposed that the human mind contains evolved, domain-specific cognitive adaptations — "modules" shaped by natural selection in ancestral environments. Cheater-detection mechanisms, mate-preference heuristics, fear responses calibrated to ancestral threats — each is hypothesised to be a product of selection operating on psychological traits in the [Pleistocene](https://en.wikipedia.org/wiki/Pleistocene) environment of evolutionary adaptedness.

[Steven Pinker](https://en.wikipedia.org/wiki/Steven_Pinker)'s *How the Mind Works* (1997) and *The Blank Slate* (2002) popularised the programme widely. The field is mainstream within parts of psychology and has generated productive research in areas including kin recognition, disgust, jealousy, and social exchange.

The criticism has been substantial. [David Buller](https://en.wikipedia.org/wiki/David_Buller_(philosopher))'s *Adapting Minds* (2005) challenged the field on methodological grounds — arguing that many of its central claims rest on "just-so stories" that are not empirically testable, that the ancestral environment is too poorly known to support confident claims about what was adaptive, and that the modularity thesis is not well supported by cognitive neuroscience. [Richard Lewontin](https://en.wikipedia.org/wiki/Richard_Lewontin) and [Jerry Fodor](https://en.wikipedia.org/wiki/Jerry_Fodor) raised theoretical objections: Lewontin against adaptationism generally (the assumption that every trait is an adaptation), Fodor against massive modularity specifically.
...
The question of whether economics could be an evolutionary science is older than the Modern Synthesis. [Thorstein Veblen](https://en.wikipedia.org/wiki/Thorstein_Veblen) asked "Why is economics not an evolutionary science?" in 1898, arguing that neoclassical economics' equilibrium framework missed the dynamic, cumulative, and path-dependent character of economic change. [Joseph Schumpeter](https://en.wikipedia.org/wiki/Joseph_Schumpeter)'s concept of creative destruction — the constant revolutionising of economic structure from within — drew on evolutionary metaphors, though Schumpeter was not a Darwinian in a technical sense.
