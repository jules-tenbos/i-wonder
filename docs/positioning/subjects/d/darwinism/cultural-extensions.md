...
The criticism has been substantial. [David Buller](https://en.wikipedia.org/wiki/David_Buller_(philosopher))'s *Adapting Minds* (2005) challenged the field on methodological grounds — arguing that many of its central claims rest on "just-so stories" that are not empirically testable, that the ancestral environment is too poorly known to support confident claims about what was adaptive, and that the modularity thesis is not well supported by cognitive neuroscience. [Richard Lewontin](/positioning/persons/l/lewontin/) and [Jerry Fodor](https://en.wikipedia.org/wiki/Jerry_Fodor) raised theoretical objections: Lewontin against adaptationism generally (the assumption that every trait is an adaptation), Fodor against massive modularity specifically.
