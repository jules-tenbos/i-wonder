---
layout: default
title: "The Integration with Genetics"
description: "How Darwinism became genetically grounded — from Mendel's rediscovery in 1900 through population genetics and the Modern Synthesis to the molecular era."
lastmod: 2026-05-16
---

[Home](/) > [Positioning](/positioning/) > [Subjects](/positioning/subjects/) > [Darwinism](/positioning/subjects/d/darwinism/) > The Integration with Genetics

# The Integration with Genetics
...
[Gregor Mendel](https://en.wikipedia.org/wiki/Gregor_Mendel)'s experiments on pea plants, published in 1866, described discrete hereditary factors — what would later be called genes — transmitted from parent to offspring according to predictable ratios. The work was largely overlooked for thirty-four years. In 1900, three botanists — [Hugo de Vries](https://en.wikipedia.org/wiki/Hugo_de_Vries), [Carl Correns](https://en.wikipedia.org/wiki/Carl_Correns), and [Erich von Tschermak](https://en.wikipedia.org/wiki/Erich_von_Tschermak) — independently rediscovered Mendel's laws and recognised their significance.

The rediscovery created a problem. Mendelian inheritance appeared to involve discrete, all-or-nothing factors — tall or short, wrinkled or smooth. Darwinian selection seemed to require continuous, graded variation — slightly taller, slightly faster, slight shifts in coloration. Through the first two decades of the twentieth century, Mendelians (de Vries, [William Bateson](https://en.wikipedia.org/wiki/William_Bateson)) and biometricians ([Karl Pearson](https://en.wikipedia.org/wiki/Karl_Pearson), [W. F. R. Weldon](https://en.wikipedia.org/wiki/W._F._R._Weldon)) argued past each other, each convinced the other's framework was fundamentally wrong. The controversy was real and sharp, not a minor disagreement.
...
The "Synthesis" framing has itself been questioned by historians of biology. [Betty Smocovitis](https://en.wikipedia.org/wiki/Vassiliki_Betty_Smocovitis) (*Unifying Biology*, 1996) and [William Provine](https://en.wikipedia.org/wiki/William_B._Provine) in his later writing argued that the Synthesis was less unified than the term suggests — that it was partly a retrospective construction, consolidated at the 1959 Darwin centenary celebrations, smoothing over real disagreements among its architects. Whether the Synthesis was a genuine intellectual unification or a partially constructed consensus is itself debated.

## The molecular era

The discovery of DNA's structure in 1953 — by [James Watson](https://en.wikipedia.org/wiki/James_Watson) and [Francis Crick](https://en.wikipedia.org/wiki/Francis_Crick), drawing on the X-ray crystallography of [Rosalind Franklin](https://en.wikipedia.org/wiki/Rosalind_Franklin) —, and the elucidation of the genetic code through the 1960s, provided the physical substrate Darwin had been missing. Inheritance was no longer an abstraction or a mathematical variable — it was a molecule whose structure, replication, and mutation could be studied directly.
...
- Mayr, E., & Provine, W. B. (Eds.). (1980). *The Evolutionary Synthesis: Perspectives on the Unification of Biology*. Harvard University Press.
- Smocovitis, V. B. (1996). *Unifying Biology: The Evolutionary Synthesis and Evolutionary Biology*. Princeton University Press.
- Bowler, P. J. (2009). *Evolution: The History of an Idea* (4th ed.). University of California Press.

---

See also: [Darwin](/positioning/persons/d/darwin/) · [The mechanism](/positioning/subjects/d/darwinism/the-mechanism/) · [After the Synthesis](/positioning/subjects/d/darwinism/after-the-synthesis/)
