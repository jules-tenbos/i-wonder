...
Williams' 1966 critique largely suppressed group selection as a respectable concept in evolutionary biology for two decades. Its revival came through [David Sloan Wilson](https://en.wikipedia.org/wiki/David_Sloan_Wilson) and [Elliott Sober](/positioning/persons/s/sober/), whose *Unto Others: The Evolution and Psychology of Unselfish Behavior* (1998) argued that selection can and does operate at multiple levels simultaneously — on genes, organisms, and groups — and that the question is not which level is "real" but how the relative strengths of selection at different levels interact in particular cases.
