...
layout: default
lastmod: 2026-05-25
title: "CAS — Adjacent traditions"
description: "Traditions adjacent to complex adaptive systems — cybernetics, general systems theory, chaos, cellular automata, evolutionary theory, network science, statistical mechanics. Where the boundaries are sharp and where they are fuzzy."
---

[Home](/) > [Positioning](/positioning/) > [Subjects](/positioning/subjects/) > [Complex Adaptive Systems](/positioning/subjects/c/complex-adaptive-systems/) > Adjacent traditions

# Adjacent traditions

The intellectual neighbours of CAS as present-day traditions, not as historical feeders. The [formation and roots](/positioning/subjects/c/complex-adaptive-systems/formation-and-roots/) page covers the genealogical story — what flowed into CAS during its formation. This page maps the current boundaries: where they are sharp, where they are fuzzy, and where two traditions share territory without agreeing on what it means.
...
**Fuzzy boundary:** Second-order cybernetics ([von Foerster](/positioning/persons/v/von-foerster/), [Maturana](/positioning/persons/m/maturana/), [Varela](/positioning/persons/v/varela/)) overlaps with CAS emergentism. The observer enters the system; the system's organisation is self-produced. Maturana and Varela's [autopoiesis](/positioning/subjects/a/autopoiesis/) — the claim that living systems produce their own components and thereby maintain their organisation — is a parallel development that shares CAS's emphasis on self-production without sharing its agent-and-population framework. The two traditions read each other but do not merge: autopoietic theory is about operational closure; CAS is about adaptive openness.

## General systems theory

**Sharp boundary:** CAS specifies its primitive — the adaptive agent. General systems theory ([von Bertalanffy](/positioning/persons/b/bertalanffy/)) sought universal principles across domains without specifying what the system is made of. The generality is the point for GST; the specificity is the point for CAS.

**Fuzzy boundary:** The cross-disciplinary ambition is shared. Systems thinking ([Peter Senge](https://en.wikipedia.org/wiki/Peter_Senge)'s *The Fifth Discipline*, [Donella Meadows](https://en.wikipedia.org/wiki/Donella_Meadows)' *Thinking in Systems*) and system dynamics ([Jay Forrester](https://en.wikipedia.org/wiki/Jay_Wright_Forrester)'s stock-and-flow models) sit in the neighbourhood — they study feedback-driven dynamics across domains, often without the adaptive-agent commitment. Some practitioners mix CAS and systems-dynamics vocabulary freely; others maintain the distinction.
...
A peer rather than a predecessor. [Wolfram](https://en.wikipedia.org/wiki/Stephen_Wolfram)'s classification of cellular automaton behaviour; [Conway](https://en.wikipedia.org/wiki/John_Horton_Conway)'s Game of Life; von Neumann's self-reproducing automata.
...
**Fuzzy boundary:** Artificial life bridges the two. [Langton](/positioning/persons/l/langton/)'s work at SFI treated cellular automata as the substrate for CAS-like dynamics — simple local rules producing lifelike behaviour. When CA rules are allowed to evolve (as in genetic programming applied to CA rule spaces), the boundary with CAS dissolves.

## Evolutionary theory

Ancestral rather than adjacent. [Darwin](/positioning/persons/d/darwin/), population genetics, the modern synthesis — CAS draws on variation-and-selection as its core adaptive mechanism. The relationship is not one of neighbourhood but of inheritance.
...
A substantial peer. [Barabási](/positioning/persons/b/barabasi/)'s scale-free networks, [Watts](https://en.wikipedia.org/wiki/Duncan_J._Watts) and [Strogatz](https://en.wikipedia.org/wiki/Steven_Strogatz)'s small-world networks, [Newman](https://en.wikipedia.org/wiki/Mark_Newman)'s community detection — network science developed its own identity in the late 1990s and 2000s, partly out of CAS and partly out of graph theory and statistical physics.
