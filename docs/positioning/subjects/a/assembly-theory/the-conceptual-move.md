...
layout: default
lastmod: 2026-05-26
title: "Assembly Theory — The Conceptual Move"
description: "The move that defines assembly theory: relocating complexity from object-properties to object-trajectories. The formal apparatus — assembly index, pathway, copy number, assembly equation — implements the move."
---

[Home](/) > [Positioning](/positioning/) > [Subjects](/positioning/subjects/) > [Assembly Theory](/positioning/subjects/a/assembly-theory/) > The Conceptual Move
...
The apparatus gives the conceptual move its formal teeth. What follows from it — the [biosignature claim](/positioning/subjects/a/assembly-theory/the-biosignature-claim/) that high assembly index signals selection, and the [metaphysical extension](/positioning/subjects/a/assembly-theory/time-as-object/) that time is a material property of objects — each builds on this foundation.
