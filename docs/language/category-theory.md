...
The [Yoneda Lemma](https://en.wikipedia.org/wiki/Yoneda_lemma) is a central result. The totality of an object's relationships to every other object in the category is a complete characterisation. What can be known about an object lives entirely in its relational profile.

## Convergence with the Seed
