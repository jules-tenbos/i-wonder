...
With language we have interaction at a point in time. Historicity stretches a point of existence into duration. Retention carries the past into the present; anticipation — shaped by what has been retained — projects the present into the future. Without historicity, existence is a point: bare differentiation, constancy. With it, the point becomes a span that reaches in both directions. The present is never an instant. See the [seed page on historicity](/seed/historicity/) for where [Heidegger](/positioning/persons/h/heidegger/), [Gadamer](/positioning/persons/g/gadamer/) and [Bergson](/positioning/persons/b/bergson/) each take this.
