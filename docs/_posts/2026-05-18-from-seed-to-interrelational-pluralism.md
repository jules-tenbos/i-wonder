...
- What follows across the branches:
  ...
  - Ontology: beings arise through differentiation, no fixed inventory
  - Epistemology: knowledge as convergence, shared subjective objectivity
  - Ethics: values inside language games, not meta-binding across communities
- Signals the anthropocentric starting point
- Three load-bearing claims set out plainly
- Relativism worry flagged; P4 + P5 as the apparatus that holds plurality together
...
**Pluralism**: the recognition that reality is multiple.

**Interrelational pluralism**: the recognition that reality is multiple, the multiple interact, and through their interaction create more.

## Testing the stance against existing thought
...
**Verdict:** "Reality is multiple" is clean — James, Whitehead, Deleuze, Goodman accept it. "The multiple interact and through interaction create more" is where most drop off. Only Whitehead has the creative mechanism, loaded with apparatus the seed doesn't carry. James gets open-endedness without the mechanism. Deleuze gets differentiation-as-creative but as internal to the one.

**Note:** The stance dissolves the ontological/epistemological split. If reality is what subjects have retained through language, then different ways of knowing ARE different realities — not perspectives on one world, but different realities constituted through different languages.

## How the principles express "multiple"
...
## Angles under the umbrella

These are aspects of interrelational pluralism that existing pluralisms capture partially:

1. **Relational ontology** — reality constituted by relations, not substances. Whitehead, Rovelli, category theory. Each in its own domain; none spans the full gradient.
2. **Epistemological pluralism** — no privileged method. Feyerabend, Goodman, Lyotard. Gets "no privilege" right but is mostly static — pluralism without the creative engine.
3. **Anti-representationalism** — meaning is not representation. Wittgenstein, Brandom, Rorty. Gets language right; doesn't extend beyond the human case.
4. **Pragmatist convergence** — truth as convergence, not correspondence. Peirce, Rorty, Habermas. Gets convergence right; stays human-scale.
5. **Phenomenology of the subject** — experience from within, no outside view, historicity. Husserl, Merleau-Ponty, Heidegger, Gadamer. Gets the subject right; doesn't extend the gradient below the human.
6. **Privacy and decentralisation** — privacy as constitutive, communities forming from below. Jonas, Ostrom, Polanyi. Gets consequences right; doesn't connect to the creative engine.
7. **Creativity as foundational** — creation as primary process. Whitehead, Bergson. Gets the dynamic right; doesn't ground it in the interrelational mechanism.
