...
And the composition of the path says the same thing from another side. A relational path is made of relations, and its constituents have been walked before — each one already expressed, already part of experienced reality, in some other configuration. What the medium holds in potential is not alien material waiting for first contact; it is reality already lived, available for a combination that has not been. <a href="https://en.wikipedia.org/wiki/W._Brian_Arthur">W. Brian Arthur</a> reached the same conclusion about technology: every new technology, he showed, is a combination of technologies that already exist — invention is recombination, and the radically new is built entirely from the previously made. The unwalked path builds on paths already walked. What is new is the walking of this configuration, not the ground it crosses.
