[Home](/) > [Engineering](/engineering/) > [Technology](/engineering/technology/) > [bare-for-pear](/engineering/technology/bare-for-pear/) > [avsc](/engineering/technology/bare-for-pear/avsc/) > Schema Parsing
