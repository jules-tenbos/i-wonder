...
- **Clone** — spawn a new subject reality, complete with full history and embedded process.
- **Branch** — diversify within a reality without losing the original.
- **Merge** — reconcile divergent realities. Conflicts as how decentralised realities deal with divergence — not prevented, resolved when the realities meet.
