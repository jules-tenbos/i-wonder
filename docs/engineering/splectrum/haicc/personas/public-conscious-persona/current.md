[Home](/) > [Engineering](/engineering/) > [SPLectrum](/engineering/splectrum/) > [HAICC](/engineering/splectrum/haicc/) > [Personas](/engineering/splectrum/haicc/personas/) > [Public Conscious Persona](/engineering/splectrum/haicc/personas/public-conscious-persona/) > Current
...
- `docs/vocabulary/` is the master for terms (per language game)
