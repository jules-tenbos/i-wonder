...
Language is not representation — it is relation. Meaning arises from use, not from definitions. This is [Wittgenstein](/positioning/persons/w/wittgenstein)'s language games and [Saussure](/positioning/persons/s/saussure)'s differential signs: the sign has no content in itself, only in relation to other signs in the system.
