---
title: Language reference page update
type: post-topic
status: draft-ready
---

# Language Reference Page Update

Reference library only — material to add to docs/language/index.md. Sourced from splectrum-foundation positioning/language.md.

---

## Ground dimension (new section)
...
## The personal and the shared (new section)
...
Concepts are the filters that make sharing possible. "Slab" extracts the minimum both participants need. Everything else is filtered out. Language mediates shared reality by selecting what converges across personal experience. This is [Wittgenstein](https://plato.stanford.edu/entries/wittgenstein/)'s language games at work — and [Rorty](https://plato.stanford.edu/entries/rorty/)'s knowledge as convergence of subjects.
