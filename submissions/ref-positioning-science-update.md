---
title: Positioning science reference update
type: post-topic
status: draft-ready
---

# Positioning Science Reference Update

Reference library only — material to add to docs/positioning.md science section. Sourced from splectrum-foundation positioning/western-science.md.
...
## RQM — from the seed's context (expand existing)
