...
- Who earns a person page: a figure the **close-affinity** rings reference. A figure named only on a neutral subject page — one camp among the many the subject holds equally — stays external; the subject page carries the whole field, and not every name in it is owed a page. The close-affinity reference is the trigger, because that is where the figure is load-bearing to a SPLectrum-side reading. (Once a page is built, backfill its mentions everywhere per the posting-guide — including the subject-page citation.) This keeps the person set to figures doing resonance work, not a gazetteer of everyone a subject page mentions.
