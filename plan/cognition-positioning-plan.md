...
**Deliverable queued, not opened:** a seed-side close-affinity piece on basal cognition (by resonance point, per the CA convention). **Scope settled in discussion 2026-08-22 (Jules's register correction is governing):**
...
**Held for its own discussion:** the Levin thread — the cognitive light cone (size of largest pursuable goal) against agency-as-degrees-of-freedom; touches the subject-definition work and possibly the QM/QI programme's viable-envelope material. *(A separate general fence question — the mark-of-the-cognitive as a demand for a privileged description, beyond basal cognition — was raised and not decided; it does not belong to the CA piece.)*
