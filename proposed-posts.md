# Proposed Posts — Roadmap

## Confirmed — March (scheduled)

1. **March 22 — From Language to Form of Life** (Wittgenstein) — written, scheduled
2. **March 27 — Philosophy as Conversation** (Rorty) — notes ready
3. **April 1 — The Body as Medium** (Merleau-Ponty) — notes ready

## Territory: The Turn — philosophy emphasis

- **April 6 — From the Turn to the Present** — the philosophical turn seen whole. From Kant through the encounters to now. What becomes visible when you see the full arc at once. Gestures toward science making the same move. Scheduled on Blogger.
...
Encounters (1–3) → the turn (philosophy, then science) → RQM → building from the seed. Life and engineering posts woven in throughout. No fixed schedule beyond March — sequence emerges from the work.
