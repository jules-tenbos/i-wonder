...
I finally did it, my blog is up and running with blog posts scheduled weeks ahead. As I am writing this six posts have been published and six more scheduled. The shared authorship — AI collaborative — is working, it is a godsend. It is a relay game where each knowing their role, completing tasks until the final product is delivered. Such a good feeling that I am able to concentrate on creative writing knowing that I am well supported.

The blog isn't the only accomplishment. Splectrum was born and made it through the neonatal period: the seed principles make sense when looked at within the context of current thinking. Splectrum has made it into its infancy. Time to start developing identity. The blog forms a big part of that. We are doing it the Rorty way, conversational. I want the blog to be the public conscious persona of Splectrum. So it is time for a bit of engineering!

Public conscious persona — what does that mean? It is Splectrum's outward-facing voice, speaking from conscious thought. Each post is a conversational piece for public consumption, focussed on well-defined subject matter. The blog is and owns the public conscious persona. It is a language game wired into it.
...
Within Splectrum engineering I am working on a new repository structure — mycelium — and repositories can use the linking capabilities of mycelium to seamlessly make this information available to the blog repository. In this post it is just assumed that the information pops up within the repo — in the submissions folder. The blog repo can't control what gets in there, what becomes a conscious thought, it just happens.

Great, the blog repo now has access to all those conscious bits of information. And more importantly, from hereon in it owns them. It can decide to forget about the thought (flag as rejected) or think it through. Conscious thoughts are not just thrown out there — they need to be shaped to become part of the public conversation of the blog. The pipeline between submission and publishing is the draft stage.
...
For the full technical detail of how the persona is wired, see the [Public Conscious Persona 1.0](https://jules-tenbos.github.io/in-wonder/engineering/personas/public-conscious-persona/current) page.

Welcome to Splectrum — Public Conscious Persona 1.0.

<small>More on the engineering in the <a href="https://jules-tenbos.github.io/in-wonder/engineering/personas/">engineering area of the reference library</a>.</small>
