[Home](/) > [Engineering](/engineering/) > [SPLectrum](/engineering/splectrum/) > [HAICC](/engineering/splectrum/haicc/) > [Personas](/engineering/splectrum/haicc/personas/) > [SPLectrum Thinking Persona](/engineering/splectrum/haicc/personas/splectrum-thinking-persona/) > Context
...
Complexity grows in expression, not in power — the full power was always there (P0). More languages, more perspectives, more ways of engaging what was always there.
