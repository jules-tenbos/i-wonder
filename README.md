...
Content and research repository for [splectrum.world](https://splectrum.world).
...
**Published content**
- **[docs/](docs/)** — the Jekyll site (reference library + blog).

**In-progress**
- **[drafts/](drafts/)** — working drafts queued for completion.
- **[submissions/](submissions/)** — research submissions awaiting development; flow is submission → draft → blog conversation → eventual ref lib absorption.
